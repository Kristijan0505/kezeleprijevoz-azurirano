    ...
    >
          ...
          {[
            ...
            <Link 
              ...
              className={`
                ...
                after:bg-primary-red after:transition-all after:duration-300
                hover:after:w-full
              `}
            >
              {item.name}
      ...
      <div 
        className={`
          ...
          ${isMobileMenuOpen ? 'max-h-60 py-4' : 'max-h-0'}
        `}
      >
        <div className="container mx-auto px-6">
          {[
            ...
            <Link 
              ...
              to={item.path}
              className={`
                block py-3 text-primary-red hover:text-secondary-gold
